<!-- Pindah Datang Create Modal -->
<div class="modal fade" id="pindahdatang-create-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="pindahdatang-create-form" method="POST">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12"><br>
                    ...
                    <div class="form-group form-material" data-plugin="formMaterial">
                      ...
                      <small class="create-pindahdatang-error-jenis-kelamin text-danger"></small>
                    </div>
                    <!-- Tempat Lahir -->
                    <div class="form-group form-material" data-plugin="formMaterial">
                      ...
                      <small class="create-pindahdatang-error-tempat-lahir text-danger"></small>
                    </div>
                    <!-- Tanggal Lahir -->
                    <div class="form-group form-material" data-plugin="formMaterial">
                      ...
                      <small class="create-pindahdatang-error-tanggal-lahir text-danger"></small>
                    </div>
                    <!-- Kewarganegaraan -->
                    <div class="form-group form-material" data-plugin="formMaterial">
                      ...
                      <small class="create-pindahdatang-error-kewarganegaraan text-danger"></small>
                    </div>
                    <!-- Gol. Darah -->
                    <div class="form-group form-material" data-plugin="formMaterial">
                      ...
                      <small class="create-pindahdatang-error-golongan-darah text-danger"></small>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12"><br>
                    ...
                    <div class="form-group form-material" data-plugin="formMaterial">
                      ...
                      <small class="create-pindahdatang-error-agama text-danger"></small>
                    </div>
                    <!-- Status Perkawinan -->
                    <div class="form-group form-material" data-plugin="formMaterial">
                      ...
                      <small class="create-pindahdatang-error-status-perkawinan text-danger"></small>
                    </div>
                    <!-- Status Perkawinan -->
                    <div class="form-group form-material" data-plugin="formMaterial">
                    ...
                    <div class="form-group form-material" data-plugin="formMaterial">
                      ...
                      <small class="create-pindahdatang-error-pendidikan text-danger"></small>
                    </div>
                    <!-- Pekerjaan -->
                    <div class="form-group form-material" data-plugin="formMaterial">
                      ...
                      <small class="create-pindahdatang-error-pekerjaan text-danger"></small>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="container">
                <div class="row">
                  <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12"><br>
                    <!-- Alamat Sebelumnya -->
                    <div class="form-group form-material" data-plugin="formMaterial">
                      <label class="form-control-label" for="alamat_lama">Alamat Sebelumnya</label>
                      <textarea class="form-control" id="create-alamat-lama" name="alamat_lama" rows="5"></textarea>
                      <small class="create-pindahdatang-error-alamat-lama text-danger"></small>
                    </div>
                    <!-- Alamat Sekarang -->
                    <div class="form-group form-material" data-plugin="formMaterial">
                    ...
                    <div class="form-group form-material" data-plugin="formMaterial">
                      ...
                      <small class="create-pindahdatang-error-kelurahan text-danger"></small>
                    </div>
                  </div>
                </div>
              </div>
...
<!-- Pindah Datang Show Modal -->
<div class="modal fade" id="pindahdatang-show-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <form id="pindahdatang-show-form" method="POST">
        <div class="modal-body">
          <!-- Tab Pindah Datang -->
          <ul class="nav nav-tabs nav-tabs-line">
            <li class="nav-item">
              ...
              <div class="container">
                <div class="row">
                  <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12"><br>
                    ...
                    <div class="form-group form-material" data-plugin="formMaterial">
                      <label class="form-control-label" for="alamat_lama">Alamat Sebelumnya</label>
                      <textarea class="form-control" id="show-alamat-lama" name="alamat_lama" rows="5" readonly></textarea>
                    </div>
                    <!-- Alamat Sekarang -->
                    <div class="form-group form-material" data-plugin="formMaterial">
                      <label class="form-control-label" for="alamat_sekarang">Alamat Sekarang</label>
...
<!-- Pindah Datang Edit Modal -->
<div class="modal fade" id="pindahdatang-edit-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <form id="pindahdatang-edit-form" method="POST">
        <div class="modal-body">
          <!-- Tab Pindah Datang -->
          <ul class="nav nav-tabs nav-tabs-line">
            <li class="nav-item">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12"><br>
                    ...
                    <div class="form-group form-material" data-plugin="formMaterial">
                      ...
                      <small class="edit-pindahdatang-error-jenis-kelamin text-danger"></small>
                    </div>
                    <!-- Tempat Lahir -->
                    <div class="form-group form-material" data-plugin="formMaterial">
                      <label class="form-control-label" for="tempat_lahir">Tempat Lahir</label>
                      <input type="text" class="form-control" id="edit-tempat-lahir" name="tempat_lahir" placeholder="Masukkan Tempat Lahir" maxlength="16" />
                      <small class="edit-pindahdatang-error-tempat-lahir text-danger"></small>
                    </div>
                    <!-- Tanggal Lahir -->
                    <div class="form-group form-material" data-plugin="formMaterial">
                      <label class="form-control-label" for="tanggal_lahir">Tanggal Lahir</label>
                      <input type="text" class="form-control" id="edit-tanggal-lahir" name="tanggal_lahir" />
                      <small class="edit-pindahdatang-error-tanggal-lahir text-danger"></small>
                    </div>
                    <!-- Kewarganegaraan -->
                    <div class="form-group form-material" data-plugin="formMaterial">
                      <label class="form-control-label" for="jenis_kelamin">Kewarganegaraan</label>
                      ...
                      <small class="edit-pindahdatang-error-kewarganegaraan text-danger"></small>
                    </div>
                    <!-- Gol. Darah -->
                    <div class="form-group form-material" data-plugin="formMaterial">
                      <label class="form-control-label" for="gol_darah">Gol. Darah</label>
                      ...
                      <small class="edit-pindahdatang-error-golongan-darah text-danger"></small>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12"><br>
                    ...
                    <div class="form-group form-material" data-plugin="formMaterial">
                      ...
                      <small class="edit-pindahdatang-error-agama text-danger"></small>
                    </div>
                    <!-- Status Perkawinan -->
                    <div class="form-group form-material" data-plugin="formMaterial">
                      <label class="form-control-label" for="status_perkawinan">Status Perkawinan</label>
                      ...
                      <small class="edit-pindahdatang-error-status-perkawinan text-danger"></small>
                    </div>
                    <!-- Status Perkawinan -->
                    <div class="form-group form-material" data-plugin="formMaterial">
                      <label class="form-control-label" for="shdk">SHDK</label>
                    ...
                    <div class="form-group form-material" data-plugin="formMaterial">
                      ...
                      <small class="edit-pindahdatang-error-pendidikan text-danger"></small>
                    </div>
                    <!-- Pekerjaan -->
                    <div class="form-group form-material" data-plugin="formMaterial">
                      <label class="form-control-label" for="pekerjaan">Pekerjaan</label>
                      ...
                      <small class="edit-pindahdatang-error-pekerjaan text-danger"></small>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="container">
                <div class="row">
                  <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12"><br>
                    ...
                    <div class="form-group form-material" data-plugin="formMaterial">
                      <label class="form-control-label" for="alamat_lama">Alamat Sebelumnya</label>
                      <textarea class="form-control" id="edit-alamat-lama" name="alamat_lama" rows="5"></textarea>
                      <small class="edit-pindahdatang-error-alamat text-danger"></small>
                    </div>
                    <!-- Alamat Sekarang -->
                    <div class="form-group form-material" data-plugin="formMaterial">
                      <label class="form-control-label" for="alamat_sekarang">Alamat Sekarang</label>
                    ...
                    <div class="form-group form-material" data-plugin="formMaterial">
                      ...
                      <small class="edit-pindahdatang-error-rt text-danger"></small>
                    </div>
                    <!-- RW -->
                    <div class="form-group form-material" data-plugin="formMaterial">
                      <label class="form-control-label" for="rw">RW</label>
                      <input type="number" class="form-control" id="edit-rw" name="rw" />
                      <small class="edit-pindahdatang-error-rw text-danger"></small>
                    </div>
                    <!-- Kelurahan -->
                    <div class="form-group form-material" data-plugin="formMaterial">
                      <label class="form-control-label" for="kelurahan">Kelurahan</label>
                      ...
                      <small class="edit-pindahdatang-error-kelurahan text-danger"></small><br>
